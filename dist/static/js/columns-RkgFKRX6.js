var te=Object.defineProperty;var A=Object.getOwnPropertySymbols;var ae=Object.prototype.hasOwnProperty,ie=Object.prototype.propertyIsEnumerable;var N=(e,t,n)=>t in e?te(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n,R=(e,t)=>{for(var n in t||(t={}))ae.call(t,n)&&N(e,n,t[n]);if(A)for(var n of A(t))ie.call(t,n)&&N(e,n,t[n]);return e};import{a as _e}from"./data-eeQ8D_f9.js";import{d as oe,r as y,V as P,a7 as D,O as ue,p as re,q as se,e as c,c as j,k as v,F as L,l as q,E as x,dH as K,af as V,m as T,R as F,I as de,C as w,f as M,B as W,al as H,ag as le,n as J,i as me,dI as ce,a0 as ve,A as be}from"./index-BmVpTjm9.js";/*! *****************************************************************************
...
***************************************************************************** */function U(e,t,n,o){function u(b){return b instanceof n?b:new n(function(a){a(b)})}return new(n||(n=Promise))(function(b,a){function l(h){try{p(o.next(h))}catch(g){a(g)}}function r(h){try{p(o.throw(h))}catch(g){a(g)}}function p(h){h.done?b(h.value):u(h.value).then(l,r)}p((o=o.apply(e,t||[])).next())})}function pe(e,t,n){let o=document.createElement(e);return o.setAttribute("class",t),n&&(o.innerText=n),o}const G=function(e){let t=Array.isArray(e)?[]:{};if(e&&typeof e=="object")for(let n in e)e.hasOwnProperty(n)&&(e[n]&&typeof e[n]=="object"?t[n]=G(e[n]):t[n]=e[n]);return t};var C=oe({name:"MouseMenu",props:{appendToBody:{type:Boolean,default:!0},menuWidth:{type:Number,default:200},menuList:{type:Array,required:!0},menuHiddenFn:{type:Function},hasIcon:{type:Boolean,default:!1},iconType:{type:String,default:"font-icon"},menuWrapperCss:Object,menuItemCss:Object,el:{type:Object,required:!0},params:{type:[String,Number,Array,Object]},useLongPressInMobile:Boolean,longPressDuration:Number,longPressPreventDefault:[Function,Boolean],injectCloseListener:{type:Boolean,default:!0},customClass:String,disabled:{type:Function}},emits:["open","close"],setup(e,{emit:t}){const n=y(0),o=y(0),u=y(!1),b=y(0),a=y(0),l=y(!1),r=y(null),p=y([]),h=P(()=>e.menuList.some(_=>_.children&&_.children.length>0)),g=y(10),S=y();D(l,_=>U(this,void 0,void 0,function*(){var s,d;if(_){yield J();let m=S.value;e.menuWrapperCss&&Object.keys(e.menuWrapperCss).map(f=>{m.style.setProperty(`--menu-${f}`,e.menuWrapperCss&&e.menuWrapperCss[f])}),e.menuItemCss&&Object.keys(e.menuItemCss).map(f=>{m.style.setProperty(`--menu-item-${f}`,e.menuItemCss&&e.menuItemCss[f])});let i=(d=(s=e.menuItemCss)===null||s===void 0?void 0:s.arrowSize)===null||d===void 0?void 0:d.match(/\d+/);i?g.value=~~i[0]||10:g.value=10,m.style.setProperty("--menu-item-arrowRealSize",g.value/2+"px"),t("open")}else t("close")}));const Q=(_,s)=>{_.disabled||(_.fn&&typeof _.fn=="function"&&_.fn(e.params,r.value,e.el,s),l.value=!1)},X=(_,s)=>{_.disabled||(_.fn&&typeof _.fn=="function"&&!_.disabled&&(_.fn(e.params,r.value,e.el,s),u.value=!1),l.value=!1)},Y=(_,s)=>{if(s.children&&!s.disabled){u.value=!0;const d=_.currentTarget;if(!d)return;const{offsetWidth:m}=d,i=d.querySelector(".__menu__sub__wrapper");if(!i)return;const{offsetWidth:f,offsetHeight:k}=i,{innerWidth:ne,innerHeight:O}=window,{top:E,left:$}=d.getBoundingClientRect();$+m+f>ne-5?n.value=$-f+5:n.value=$+m,E+k>O-5?o.value=O-k:o.value=E+5}},I=(_,s,d,m)=>_.map(i=>(i.children&&(i.children=I(i.children,s,d,m)),i.label&&typeof i.label=="function"&&(i.label=i.label(m,s,d)),i.tips&&typeof i.tips=="function"&&(i.tips=i.tips(m,s,d)),i.icon&&typeof i.icon=="function"&&(i.icon=i.icon(m,s,d)),i.hidden&&typeof i.hidden=="function"&&(i.hidden=i.hidden(m,s,d)),i.disabled&&typeof i.disabled=="function"&&(i.disabled=i.disabled(m,s,d)),i)),Z=(_=0,s=0)=>U(this,void 0,void 0,function*(){if(r.value=document.elementFromPoint(_-1,s-1),e.menuHiddenFn?l.value=!e.menuHiddenFn(e.params,r.value,e.el):l.value=!0,!l.value)return;p.value=G(e.menuList),p.value=I(p.value,r.value,e.el,e.params),yield J();const{innerWidth:d,innerHeight:m}=window,f=S.value.offsetHeight,k=e.menuWidth||200;a.value=_+k+1>d?d-k-5:_+1,b.value=s+f+1>m?m-f-5:s+1}),ee=()=>{l.value=!1},z=P(()=>e.useLongPressInMobile&&"ontouchstart"in window?"touchstart":"mousedown"),B=_=>{S.value&&!S.value.contains(_.currentTarget)&&(l.value=!1,document.oncontextmenu=null)};return D(()=>e.injectCloseListener,_=>{_?document.addEventListener(z.value,B):document.removeEventListener(z.value,B)},{immediate:!0}),ue(()=>{document.removeEventListener(z.value,B)}),{subLeft:n,subTop:o,hoverFlag:u,menuTop:b,menuLeft:a,showMenu:l,clickDomEl:r,calcMenuList:p,arrowSize:g,hasSubMenu:h,MenuWrapper:S,handleMenuItemClick:Q,handleSubMenuItemClick:X,handleMenuMouseEnter:Y,show:Z,close:ee,clickEventKey:z}}});re("data-v-3d21bc0a");const he=["onMouseenter"],fe={key:0,class:"__menu__item-icon"},ye=["innerHTML"],we={class:"__menu__item-label"},ge={class:"__menu__item-tips"},Ce={class:"__menu__item-arrow-after"},Se={class:"__menu__sub__item-label"},ke={class:"__menu__sub__item-tips"};se();function xe(e,t,n,o,u,b){return c(),j(le,{to:"body",disabled:!e.appendToBody},[e.showMenu?(c(),v("div",{key:0,ref:"MenuWrapper",class:x(["__menu__wrapper",e.customClass]),style:H({width:`${e.menuWidth}px`,top:`${e.menuTop}px`,left:`${e.menuLeft}px`})},[(c(!0),v(L,null,q(e.calcMenuList,(a,l)=>(c(),v(L,null,[!a.hidden&&!a.line?(c(),v("div",{key:l,class:x(["__menu__item",a.disabled&&"disabled",a.customClass]),[K(e.clickEventKey)]:V(r=>e.handleMenuItemClick(a,r),["stop"]),onMouseenter:r=>e.handleMenuMouseEnter(r,a)},[e.hasIcon?(c(),v("div",fe,[e.iconType==="font-icon"?T((c(),v("i",{key:0,class:x(a.icon)},null,2)),[[F,a.icon]]):e.iconType==="svg-icon"?T((c(),v("div",{key:1,class:"__menu__item-icon-svg",innerHTML:a.icon},null,8,ye)),[[F,a.icon]]):e.iconType==="vnode-icon"?(c(),j(de(a.icon),{key:2})):w("v-if",!0)])):w("v-if",!0),M("span",we,W(a.label),1),M("span",ge,W(a.tips||""),1),e.hasSubMenu?(c(),v("span",{key:1,class:x(["__menu__item-arrow",{show:e.hasSubMenu&&a.children}]),style:H({width:e.arrowSize+"px",height:e.arrowSize+"px"})},[T(M("span",Ce,null,512),[[F,e.hasSubMenu&&a.children]])],6)):w("v-if",!0),a.children&&a.children.length>0?T((c(),v("div",{key:2,class:"__menu__sub__wrapper",style:H({top:`${e.subTop}px`,left:`${e.subLeft}px`})},[(c(!0),v(L,null,q(a.children,(r,p)=>(c(),v(L,null,[!r.hidden&&!r.line?(c(),v("div",{key:p,class:x(["__menu__sub__item",r.disabled&&"disabled",r.customClass]),[K(e.clickEventKey)]:V(h=>e.handleSubMenuItemClick(r,h),["stop"])},[M("span",Se,W(r.label),1),M("span",ke,W(r.tips||""),1)],16)):w("v-if",!0),r.line?(c(),v("div",{key:p,class:"__menu__line"})):w("v-if",!0)],64))),256))],4)),[[F,e.hoverFlag]]):w("v-if",!0)],16,he)):w("v-if",!0),!a.hidden&&a.line?(c(),v("div",{key:l,class:"__menu__line"})):w("v-if",!0)],64))),256))],6)):w("v-if",!0)],8,["disabled"])}function Me(e,t){t===void 0&&(t={});var n=t.insertAt;if(!(!e||typeof document=="undefined")){var o=document.head||document.getElementsByTagName("head")[0],u=document.createElement("style");u.type="text/css",n==="top"&&o.firstChild?o.insertBefore(u,o.firstChild):o.appendChild(u),u.styleSheet?u.styleSheet.cssText=e:u.appendChild(document.createTextNode(e))}}var ze=`.__menu__mask[data-v-3d21bc0a] {
  position: fixed;
  top: 0;
  left: 0;
  bottom: 0;
